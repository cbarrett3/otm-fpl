          ...
          >
            <div className="p-4 sm:p-5">
              ...
              <p className="text-sm text-white/75 mb-4">
                Free preview reached (25 picks). Unlock the full Draftkit for <span className="text-yellow-300 font-semibold">$9.99</span> to continue.
              </p>
              <div className="flex flex-wrap items-center gap-2 mb-3">
                <Button className="h-9 px-4" onClick={handleUnlock} disabled={loading}>{loading ? 'Loading…' : 'Unlock $9.99'}</Button>
